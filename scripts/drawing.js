...
function Drawing() {
    ...
    this.addUserFrame = function() {
        this.frame = new Frame(this.graphArea);
    }
}

function Frame(graphArea) {
    var createGrid = function() {
        ...
        this.grid = new Graph(leftmost, topmost, rightmost - leftmost + 1, bottommost - topmost + 1, config.frame);
    }
    ...
    var make1x1 = function() {
        ...
        // create 1x1 frame
        this.grid = new Graph(...this.initialBox, 1, 1, config.frame);
        // and add a listener for mouse movement
        graphArea.addEventListener("mousemove", this.moveListener);
    };
    ...
    graphArea.addEventListener("mousedown", downListener.bind(this));  
